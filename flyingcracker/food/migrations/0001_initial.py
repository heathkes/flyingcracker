    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foodstuff', models.ForeignKey(related_name='ingredients', to='food.Foodstuff')),
            ],
            options={
                'ordering': ['rank'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('pub_date', models.DateField(default=datetime.date.today, null=True, verbose_name=b'date published')),
                ('directions', models.TextField(null=True, blank=True)),
                ('description', models.TextField(null=True, blank=True)),
                ('teaser', models.CharField(max_length=100, null=True, blank=True)),
                ('credit', models.TextField(null=True, blank=True)),
                ('rclass', models.CharField(default=b'D', max_length=1, choices=[(b'D', b'Drink'), (b'E', b'Eat'), (b'I', b'Ingredient')])),
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(related_name='ingredients', to='food.Recipe'),
