...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fantasy_event', 'start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 14, 0, 50, 23, 542344)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Event.start'
        db.delete_column('fantasy_event', 'start')
