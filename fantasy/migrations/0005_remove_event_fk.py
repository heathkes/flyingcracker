...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Guess.event'
        db.delete_column('fantasy_guess', 'event_id')



    def backwards(self, orm):

        # Adding field 'Guess.event'
        db.add_column('fantasy_guess', 'event', orm['fantasy.guess:event'])



    models = {
        'serviceclient.serviceclient': {
            'date_joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2009, 7, 2)'}),
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 2, 12, 8, 59, 473000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 2, 12, 8, 59, 473000)'}),
