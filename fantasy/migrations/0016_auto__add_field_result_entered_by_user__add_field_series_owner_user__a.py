...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.entered_by_user'
        db.add_column('fantasy_result', 'entered_by_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.owner_user'
        db.add_column('fantasy_series', 'owner_user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Guess.user_user'
        db.add_column('fantasy_guess', 'user_user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Result.entered_by_user'
        db.delete_column('fantasy_result', 'entered_by_user_id')

        # Deleting field 'Series.owner_user'
        db.delete_column('fantasy_series', 'owner_user_id')

        # Deleting field 'Guess.user_user'
        db.delete_column('fantasy_guess', 'user_user_id')
    ...
    models = {
        ...
        'fantasy.guess': {
            ...
            'user_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'fantasy.result': {
            ...
            'entered_by_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'fantasy.series': {
            ...
            'owner_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
