...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.short_name'
        db.add_column('fantasy_team', 'short_name', orm['fantasy.team:short_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.short_name'
        db.delete_column('fantasy_team', 'short_name')
    ...
    models = {
        ...
        'fantasy.team': {
            'competitors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fantasy.Competitor']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'series': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fantasy.Series']"}),
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'default': '""'})
        },
