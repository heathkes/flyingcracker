...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.result'
        db.add_column('fantasy_result', 'result', orm['fantasy.result:result'], keep_default=False)



    def backwards(self, orm):

        # Deleting field 'Result.result'
        db.delete_column('fantasy_result', 'result')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 3, 12, 28, 33, 233000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 3, 12, 28, 33, 233000)'}),
        ...
        'fantasy.result': {
            ...
            'result': ('django.db.models.fields.CharField', [], {'max_length': '50', 'default': "''"})
        },
        'auth.permission': {
        ...
        'fantasy.series': {
            ...
            'guesses': ('generic.GenericRelation', ["orm['fantasy.Guess']"], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
