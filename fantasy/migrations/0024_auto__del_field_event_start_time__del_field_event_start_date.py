...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('fantasy_event', 'start_time')

        # Deleting field 'Event.start_date'
        db.delete_column('fantasy_event', 'start_date')
    
    
    def backwards(self, orm):
        
        # Adding field 'Event.start_time'
        db.add_column('fantasy_event', 'start_time', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2011, 2, 14, 1, 1, 51, 248209)), keep_default=False)

        # Adding field 'Event.start_date'
        db.add_column('fantasy_event', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 2, 14, 1, 1, 59, 623731)), keep_default=False)
