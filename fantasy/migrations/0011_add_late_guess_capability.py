...
class Migration:
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 7, 11, 34, 32, 890000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 7, 11, 34, 32, 890000)'}),
        ...
        'fantasy.guess': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 7, 17, 34, 32, 328000)'}),
