...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competitor.active'
        db.add_column('fantasy_competitor', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Competitor.active'
        db.delete_column('fantasy_competitor', 'active')
