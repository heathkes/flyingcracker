...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.owner'
        db.delete_column('fantasy_series', 'owner_id')

        # Deleting field 'Guess.user'
        db.delete_column('fantasy_guess', 'user_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Result.entered_by'
        db.add_column('fantasy_result', 'entered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serviceclient.ServiceClientUserProfile'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.owner'
        db.add_column('fantasy_series', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['serviceclient.ServiceClientUserProfile']), keep_default=False)

        # Adding field 'Guess.user'
        db.add_column('fantasy_guess', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['serviceclient.ServiceClientUserProfile']), keep_default=False)
